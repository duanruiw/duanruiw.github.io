 ...
 */
 ...
 (function ($) {
 	$.fn.redCountdown = function(Options, Callback) {
		...
		function SecsToDHMS() { 
			DaysLeft = 		Math.floor ( OnlySecondsLeft / (1000*60*60*24) );
			HoursLeft = 	Math.floor ( ( OnlySecondsLeft % (1000*60*60*24) ) / (1000*60*60));
			MinutesLeft =	Math.floor ( ( ( OnlySecondsLeft % (1000*60*60*24) ) % (1000*60*60) ) / (1000*60));
			SecondsLeft = 	Math.floor ( ( ( ( OnlySecondsLeft % (1000*60*60*24) ) % (1000*60*60) ) % (1000*60) ) / (1000));	
		}
		...
		function Ticking() {
			...
			OnlySecondsLeft=OnlySecondsLeft-1000;
			...
			// Replace DOM values
			Element.find(".redCountdownDays input").val(365-(365 - DaysLeft)).trigger('change');
			Element.find(".redCountdownHours input").val(24-(24 - HoursLeft)).trigger('change');
			Element.find(".redCountdownMinutes input").val(24-(60 - MinutesLeft)).trigger('change');
			Element.find(".redCountdownSeconds input").val(60-(60 - SecondsLeft)).trigger('change');
